...
class _$AuthImpl implements _Auth {
  _$AuthImpl({this.accessToken, this.refreshToken, this.user});
...
abstract class _User implements User {
  factory _User({final String? id, final String? email}) = _$UserImpl;
